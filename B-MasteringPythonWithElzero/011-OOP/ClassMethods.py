# -------------------------------------------------------------------
# Topic: Object Oriented Programming => Class Methods & Static Methods.
# -------------------------------------------------------------------
# 1. Class Methods:
# - Marked With IMPORTANT: @classmethod Decorator To Flag It As Class Method
# - It Take IMPORTANT: Cls Parameter Not Self To Point To The Class not The Instance
